    ...
    <div style={{ padding: "clamp(32px, 5vw, 56px)", maxWidth: "880px" }}>
      ...
      <div className="grid grid-cols-3 gap-4" style={{ marginBottom: "48px" }}>
        {[
          ...
          { label: "Cursos",   value: 0,             to: "/dashboard/courses" },
          { label: "Servicios",value: 0,             to: "/dashboard/services" },
        ].map(({ label, value, to }) => (
      ...
      <div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center",
          ...
          <Link to="/dashboard/orders" style={{ fontSize: "13px", color: "var(--text-3)",
        ...
        {!isLoading && recent.length > 0 && (
          <div style={{ background: "var(--surface)", border: "1px solid var(--border)",
            ...
            {recent.map((order, i) => (
              ...
              >
                <div>
                  <p style={{ fontSize: "13px", fontWeight: 500, fontVariantNumeric: "tabular-nums",
